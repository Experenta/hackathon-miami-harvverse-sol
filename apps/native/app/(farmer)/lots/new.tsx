			...
			<Animated.View entering={FadeIn.delay(50).duration(200)}>
				{draftSaved ? (
					...
					<Banner
						tone="info"
						title="Draft first"
						description="Fill required fields and save the draft before running helper actions or publishing."
					/>
				)}
			</Animated.View>
			...
			<Animated.View entering={FadeInUp.delay(75).duration(250)}>
				...
				>
					<ActionBar>
						...
						>
							Required fields and share split validation apply
							before saving.
						</Text>
					</ActionBar>
						...
						>
							...
							>
								<Banner
									...
									description="These shortcuts use demo payloads for testing the publish flow."
								>
									<View
										style={{
											flexDirection: "row",
