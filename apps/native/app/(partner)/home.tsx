      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={{ gap: theme.spacing.lg }}>
            ...
            {/* Inline identity row */}
            {rolePda ? (
              <Animated.View entering={FadeIn.delay(75).duration(150)}>
                <View
                  style={{
                    flexDirection: "row",
                    alignItems: "center",
                    gap: theme.spacing.xs,
                    backgroundColor: "rgba(103, 185, 193, 0.08)",
                ...
                >
                  ...
                  />
                  <Text
                    style={[theme.typography.caption, { color: "#67B9C1" }]}
                  >
            ...
            <Animated.View entering={FadeInUp.delay(75).duration(200)}>
              <Button
                title="Browse Lots"
                variant="accent"
                onPress={() => router.push("/(partner)/catalog" as Href)}
              />
            </Animated.View>
